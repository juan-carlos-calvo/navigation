...
settings.validators.register(
    ...
    # Validator(
    #     "DB.TIMEOUT", default=lambda _settings, _value: 24 * 60 * _settings.factor
    # ),
    ...
    # Validator(
    #     "DB.PASSWORD", must_exist=True, when=Validator("DB.USER", must_exist=True)
    # ),
)
